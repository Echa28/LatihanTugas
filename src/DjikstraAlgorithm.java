...
public class DjikstraAlgorithm{
    public static void main(String args[]) {
        ...
        for(int i = 0; i<5; i++){
            distance[i] = Integer.MAX_VALUE; // diangggap jarak tiap node belum tahu
            visited[i] = false;// dianggap tiap mode belum pernah dikunjungi
        }

        distance[0] = 0; //dimulainya noded A
        for(int t=0;t<5;t++){
